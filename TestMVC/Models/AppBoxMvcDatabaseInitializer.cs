...
{
    public class AppBoxMvcDatabaseInitializer : CreateDatabaseIfNotExists<AppBoxMvcContext>  // CreateDatabaseIfNotExists DropCreateDatabaseAlways DropCreateDatabaseIfModelChanges
    {
        protected override void Seed(AppBoxMvcContext context)
        {
